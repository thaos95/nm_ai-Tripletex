...
So a perfect score on a Tier 2 task = `1.0 x 2 = 2.0` base score.
...
Each task has 56 unique variants (7 languages x 8 data sets), so you'll rarely see the same prompt twice.
